...
//
    ...
    bool MlpSet::Insert(uint64_t value) {
        ...
        /*
    #define LOCK_TOP_LEVELS() this->m_root_version.fetch_add(1,std::memory_order_acquire);\
        this->m_treeDepth1_version.fetch_add(1, std::memory_order_acquire);\
        this->m_treeDepth2_version.fetch_add(1, std::memory_order_acquire);
        */
...
#define LOCK_TOP_LEVELS() INC_VERSION(this->m_root_version);\
    ...
    INC_VERSION(this->m_treeDepth2_version);
        ...
        /*
    #define UNLOCK_TOP_LEVELS() this->m_root_version.fetch_add(this->m_root_version%2,std::memory_order_release); this->m_treeDepth1_version.fetch_add(this->m_root_version%2,std::memory_order_release); this->m_treeDepth2_version.fetch_add(this->m_root_version%2, std::memory_order_release);
        */
