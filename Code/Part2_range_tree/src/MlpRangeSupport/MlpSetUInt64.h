...
public:
	...
	bool Insert(uint64_t value, uint32_t *reconstructed_idx = nullptr, uint32_t *inserted_leaf_pos = nullptr, uint32_t *new_node_pos=nullptr,
                bool* split_flag=nullptr);
    ...
    void InsertPerfectRange(uint64_t low, uint64_t high, uint8_t sb);
